using CoreImage;
using FFImageLoading.Ios.Shared.Transformations;

namespace FFImageLoading.Ios.Transformations
{
    ...
    public class BlurredTransformation : TransformationBase
    {
        ...
        public static UIImage ToBlurred(UIImage source, float rad)
        {
            ...
            using (var filter = new CIGaussianBlur() { InputImage = inputImage, Radius = rad })
