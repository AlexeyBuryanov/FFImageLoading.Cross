...
using FFImageLoading.Ios.Shared.Cache;
using FFImageLoading.Ios.Shared.DataResolvers;
using FFImageLoading.Ios.Shared.Helpers;
...
namespace FFImageLoading
{
    ...
    public class ImageService : ImageServiceBase<UIImage>
    {
        ...
        protected override IDataResolverFactory CreateDataResolverFactoryInstance(Configuration configuration) => new DataResolverFactoryIos();
        ...
        {
            return (int)Math.Floor((double)(dp * ScaleHelper.Scale));
        }
